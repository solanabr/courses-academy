...
fn main() {
    ...
    let program_id = Pubkey::from_str(&counter_v1_twin::id().to_string()).unwrap();
    ...
    let (ix, signers): (Instruction, Vec<&dyn Signer>) = match mode {
        "init" => (
            Instruction {
                ...
                data: counter_v1_twin::instruction::Initialize {}.data(),
            },
            vec![&payer, &counter],
        ),
        "increment" => (
            Instruction {
                ...
                data: counter_v1_twin::instruction::Increment {}.data(),
            },
            vec![&payer],
        ),
